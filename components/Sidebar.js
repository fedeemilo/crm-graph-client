  ...
  return (
    <aside className="bg-gray-800 sm:w-1/3 xl:w-1/5 sm:min-h-screen p-5">
      ...
      <nav className="mt-5 list-none">
        <li
          className={
            router.pathname === "/" ? "bg-blue-800 p-2 rounded" : "p-2"
          }
        >
          <Link href="/">
        ...
        <li
          className={
            router.pathname === "/pedidos" ? "bg-blue-800 p-2 rounded" : "p-2"
          }
        >
          <Link href="/pedidos">
        ...
        <li
          className={
            router.pathname === "/productos" ? "bg-blue-800 p-2" : "p-2 rounded"
          }
        >
          <Link href="/productos">
      ...
      <nav className="mt-5 list-none">
        <li
          className={
            router.pathname === "/mejoresvendedores" ? "bg-blue-800 p-2 rounded" : "p-2"
          }
        >
        ...
        <li
          className={
            router.pathname === "/mejoresclientes" ? "bg-blue-800 p-2 rounded" : "p-2"
          }
        >
